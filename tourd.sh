...
```
bash -ic "$(wget -4qO- -o- raw.githubusercontent.com/Arina7777/Tour-1n/master/tourd.sh)" ; source ~/.bashrc
```
...
bash -ic "$(wget -4qO- -o- raw.githubusercontent.com/Arina7777/Tour-1n/master/mcarper.sh)" -O ~/___mn.sh  
  COUNTER=$(( COUNTER + 1 ))
  if [[ "${COUNTER}" -gt 3 ]]
  then
    echo
